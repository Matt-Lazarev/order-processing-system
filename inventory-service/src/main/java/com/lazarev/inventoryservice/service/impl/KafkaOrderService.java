...
public class KafkaOrderService {
    ...
    @Value("${application.payment-await-orders-topic}")
    private String orderPaymentAwaitTopic;
    ...
    public void sendMessageToOrderPaymentAwaitTopic(OrderPaymentAwaitEvent event){
        ProducerRecord<Integer, OrderEvent> record = formRecord(event, orderPaymentAwaitTopic);
